...
func (x *BalanceChangeRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
const file_proto_wallet_proto_rawDesc = "" +
	...
	"\n" +
	"request_id\x18\x04 \x01(\tR\trequestId\"\xac\x01\n" +
	...
	"\rWalletService\x12Q\n" +
	"\x12ApplyBalanceChange\x12\x1c.wallet.BalanceChangeRequest\x1a\x1d.wallet.BalanceChangeResponseB\x18Z\x16svc-transactions/protob\x06proto3"
